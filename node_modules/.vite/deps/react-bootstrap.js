...
import {
  ...
  Button_default2,
  useButtonProps
} from "./chunk-S2XDW7I7.js";
import {
  Col_default,
  useCol
} from "./chunk-SEL5466X.js";
import {
  Container_default
...
function forEach(children, func) {
  ...
  React21.Children.forEach(children, (child) => {
    if (React21.isValidElement(child)) func(child, index++);
  });
}
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react21.useReducer)((revision) => revision + 1, 0);
  return dispatch;
}
...
var FormGroup = React50.forwardRef(({
  ...
  const context4 = (0, import_react38.useMemo)(() => ({
    controlId
  }), [controlId]);
...
var Switch = React55.forwardRef((props, ref) => (0, import_jsx_runtime53.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
function useCallbackRef2() {
  return (0, import_react45.useState)(null);
}
...
var ModalBody = React65.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Modal = React70.forwardRef(({
  ...
  const renderBackdrop = (0, import_react46.useCallback)((backdropProps) => (0, import_jsx_runtime68.jsx)("div", {
    ...backdropProps,
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react50.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime83.jsxs)(import_jsx_runtime82.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react52.cloneElement)(children, triggerProps), (0, import_jsx_runtime81.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
